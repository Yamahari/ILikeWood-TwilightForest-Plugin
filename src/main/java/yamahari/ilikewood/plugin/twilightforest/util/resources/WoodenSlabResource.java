package yamahari.ilikewood.plugin.twilightforest.util.resources;

import net.minecraft.resources.ResourceLocation;
import yamahari.ilikewood.registry.resource.resources.IWoodenSlabResource;

public final class WoodenSlabResource
    implements IWoodenSlabResource
{
    ...
    public WoodenSlabResource(
        final ResourceLocation bottomTexture,
        final ResourceLocation topTexture,

...
public final class WoodenLogResource
    implements IWoodenLogResource
{
    ...
    public WoodenLogResource(
        final ResourceLocation endTexture,
    ...
    public WoodenLogResource(
        ...
        final ResourceLocation sideTexture,
        final ResourceLocation resource,
        final SideTextureProperties properties
    )
    {
